...
export default function ProfilePageContent() {
    ...
    const handleUpdateProfile = async (e: React.FormEvent) => {
        ...
        setLoading(true);
        try {
            // In a real app, email update might require more steps (verification)
            // But let's simulate a profile update
        ...
        <div className="space-y-8 max-w-5xl">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                ...
                <div className="lg:col-span-4 space-y-6">
                    <Card className="rounded-lg border-border bg-card shadow-sm overflow-hidden h-fit">
                        <CardHeader className="text-center pb-6 border-b border-border bg-secondary/30">
                            ...
                            <CardTitle className="text-lg font-bold">{user.email?.split('@')[0]}</CardTitle>
